...
import RegistrationListModel from '../models/registrationListModel.js';
...
const VehiclesService = {
    ...
    getRegistrationsList: async function (registrationDateFrom, registrationDateTo = null, brandIdList = null, modelIdList = null, provinceId = null, communityId = null, motorTypeId = null, serviceTypeId = null)
    {
        const url = new URL(`${VehiclesService.url}/GetRegistrationsList`);
        url.searchParams.append('RegistrationDateFrom', registrationDateFrom);
        if (registrationDateTo != null) url.searchParams.append('RegistrationDateTo', registrationDateTo);
        if (brandIdList != null) url.searchParams.append('BrandIdList', brandIdList);
        if (modelIdList != null) url.searchParams.append('ModelIdList', modelIdList);
        ...
        return fetch(url)
            ...
            .then(data => new RegistrationListModel(data.N, data.P));
    }
};
